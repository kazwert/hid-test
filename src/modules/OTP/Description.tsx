...
function Description(): JSX.Element {
  ...
  return (
    <View style={styles.containerDescription}>
      <Text style={[styles.title, styles.textSpace28]}>Verify Your Phone Number</Text>
      <Text style={styles.description}>
        Please enter the 4-digit code you
      </Text>
      <Text style={styles.description}>
        received as SMS to
      </Text>
      <Text style={[styles.phoneNumber, styles.textSpace21]}>{formatPhoneInternational({
