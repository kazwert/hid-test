...
export type LoginAction = ActionMap<LoginActionType>[keyof ActionMap<LoginActionType>];
...
export type LoginOTPAction = ActionMap<LoginOTPActionType>[keyof ActionMap<LoginOTPActionType>];
